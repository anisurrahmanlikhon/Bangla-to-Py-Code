...
|চলক    |সি-তে সাইজ / বাংলাতে সাইজ         |
|-----------------|-------------------|
| ```পূর্ণ```       | ২-৪ বাইট/প্রযোজ্য নয়        |
| ```দশম```       | ২-৪ বাইট/প্রযোজ্য নয়        |
| ```বর্ণ```      | ১ বাইট/প্রযোজ্য নয়       |
| ```ডাবল``` | ৮ বাইট/প্রযোজ্য নয়  |
|```বর্ণ অ্যারে[]```| অ্যারের সাইজ অনুযায়ী/প্রযোজ্য নয় |
