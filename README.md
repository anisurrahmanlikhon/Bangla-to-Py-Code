...
পূর্ণ মৌলিক()
{
   ...
   দেখাও("সর্বোচ্চ(৫.৯৫) = " + সর্বোচ্চ(৫.৯৫));
   দেখাও("সর্বনিম্ন(৫.৯৫) = " সর্বনিম্ন(৫.৯৫));
   দেখাও("রাউন্ড(৫.৯৫) = " রাউন্ড(৫.৯৫));
   দেখাও("বর্গমূল(২৫.০০) = " বর্গমূল(২৫.০০));
   দেখাও("ঘনমূল(২৭) = ", ঘনমূল(২৭.০০));
   দেখাও("ঘাত(২.৫, ২) = " ঘাত(২.৫, ২));
   দেখাও("পরম(-১০.০০) = " পরম(-১০.০০));
   দেখাও("সূচক(৪.০০) = " সূচক(৪.০০));
   দেখাও("লগ(৩০.৯৭) = " লগ(৩০.৯৭));
   দেখাও("লগ১০(১০.০০) = " লগ১০(১০.০০));
   দেখাও("ছাঁটাই(৪.০০) = " ছাঁটাই(৪.০০));
   দেখাও("ভাগশেষ(৮.৫, ৫.০০) = " ভাগশেষ(৮.৫, ৫.০০));
   দেখাও("ভুজ(৩০.০০) = " ভুজ(৩০.০০));
   দেখাও("কোটি(৩০.০০) = " কোটি(৩০.০০));
   দেখাও("স্পর্শক(৩০.০০) = " স্পর্শক(৩০.০০));
