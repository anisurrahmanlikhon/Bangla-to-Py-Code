...
ইন্দুর.ডাক()
```
### পাইথন মডিউলস (লাইব্রেরি ফাংশন)
```Python
অন্তর্ভুক্ত গণিত
দেখাও(গণিত.ফ্যাক্ট(৫))
````
```Python
দেখাও("গসাগু(১৫, ৯) = " + গণিত.সর্বোচ্চ(১৫, ৯))
দেখাও("সর্বোচ্চ(৫.৯৫) = " + গণিত.সর্বোচ্চ(৫.৯৫))
দেখাও("সর্বনিম্ন(৫.৯৫) = " + গণিত.সর্বনিম্ন(৫.৯৫))
দেখাও("ঘনমূল(২৭) = " + গণিত.ঘনমূল(২৭))
দেখাও("ঘাত(৩, ২) = " + গণিত.ঘাত(৩, ২))
দেখাও("পরম(-১০.০০) = " + গণিত.পরম(-১০.০০))
দেখাও("সূচক(৪.০০) = " + গণিত.সূচক(৪.০০))
দেখাও("লগ(৩০.৯৭) = " + গণিত.লগ(৩০.৯৭))
দেখাও("লগ১০(১০.০০) = " + গণিত.লগ১০(১০.০০))
দেখাও("ছাঁটাই(৪.০০) = " + গণিত.ছাঁটাই(৪.০০));
দেখাও("ভাগশেষ(৮.৫, ৫.০০) = " + গণিত.ভাগশেষ(৮.৫, ৫.০০))
দেখাও("ভুজ(৩০.০০) = " + গণিত.ভুজ(৩০.০০))
দেখাও("কোটি(৩০.০০) = " + গণিত.কোটি(৩০.০০))
দেখাও("স্পর্শক(৩০.০০) = " + গণিত.স্পর্শক(৩০.০০))
দেখাও("পাই = " + গণিত.পাই(৩০.০০))
