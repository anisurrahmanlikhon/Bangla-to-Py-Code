...
```
### অ্যারে
লিস্ট বা টাপল ও অ্যারে প্রায় একই ধরনের। লিস্ট বা টাপল একাধিক ডেটা টাইপের হতে পারে। তবে অ্যারে একই ধরনের ডেটা টাইপের হতে হয়। অ্যারের অনেকগুলো মডিউলস আছে। 

```Python
অন্তর্ভুক্ত অ্যারে
সংখ্যা = অ্যারে. অ্যারে('i', [১, ২, ৩, ৪])
দেখাও(সংখ্যা)
```
### ডিকশনারি
```Python
